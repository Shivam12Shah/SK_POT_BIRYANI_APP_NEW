...
export default function HomeV3Screen() {
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        >
          {[
            { title: 'Murgh Kefta', price: 159 },
            { title: 'Beetroot & Peanut Kebab', price: 139 },
            { title: 'Dum Kebab', price: 149 },
          ].map((p, idx) => (
            <ProductCard key={idx} title={p.title} price={p.price} />
          ))}
        </ScrollView>

        <View style={styles.grid}>
          <PromoCard title="Biryani at FLAT 269" priceTag="" />
          <PromoCard title="Biryani & Kebab thali combo" priceTag="" />
          <PromoCard title="Biryani Thali at FLAT 259" priceTag="" />
          <PromoCard title="Long Lost Biryanis" priceTag="" />
        </View>
      </ScrollView>
    </View>
  );
